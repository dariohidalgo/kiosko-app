...
const Sidebar = ({ userRole, onLogout, isOpen = false, toggleSidebar, className = '' }: SidebarProps) => {
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center h-16 bg-gray-800 text-white">
            <span className="text-xl font-semibold text-white">{userRole === "admin" ? "Admin Kiosko" : "Kiosko App"}</span>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              className="w-full py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-md"
            >
              Cerrar Sesión
            </button>
          </div>
